...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"AyiinOXD/modules/{shortname}.py")
        name = "AyiinOXD.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        # for imports
        sys.modules["AyiinOXD.modules." + shortname] = mod
        LOGS.info("Successfully imported " + shortname)
...
def start_assistant(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"AyiinOXD/modules/assistant/{shortname}.py")
        name = "AyiinOXD.modules.assistant.{}".format(shortname)
        spec = importlib.util.spec_from_file_location(name, path)
        mod = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(mod)
        ...
        mod.tgbot = bot.tgbot
        spec.loader.exec_module(mod)
        sys.modules["AyiinOXD.modules.assistant" + shortname] = mod
...
def remove_plugin(shortname):
    try:
        try:
            ...
            name = f"AyiinOXD.modules.{shortname}"
