...
from AyiinOXDimport BOT_VER as version
from AyiinOXDimport BOTLOG_CHATID
from AyiinOXDimport CMD_HANDLER as cmd
from AyiinOXDimport bot, branch, tgbot
from AyiinOXD.ayiin import ayiin_version as py_ver
from AyiinOXD.ayiin import HOSTED_ON, checking
