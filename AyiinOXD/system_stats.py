...
from AyiinOXDimport ALIVE_EMOJI, ALIVE_LOGO, ALIVE_TEKS_CUSTOM, BOT_VER, CHANNEL
from AyiinOXDimport CMD_HANDLER as cmd
from AyiinOXDimport CMD_HELP, GROUP, StartTime
from AyiinOXD.ayiin import __version__ as py_ver
...
async def amireallyalive(alive):
    ...
    output = (
        f"**Tʜᴇ [Aʏɪɪɴ-Usᴇʀʙᴏᴛ](https://github.com/AyiinOXD/Ayiin-Userbot)**\n\n"
        f"**{alive_text}**\n\n"
        f"╭✠╼━━━━━━━━━━━━━━━✠╮\n"
