...
from AyiinOXD.modules.upload_download import get_video_thumb
...
from AyiinOXD.ayiin.FastTelethon import upload_file
...
CMD_HELP.update(
    {
        ...
        \n  •  **Example :** `{cmd}google -l4 AyiinOXD` atau `{cmd}google AyiinOXD`\
    "
    }
)
