...
from AyiinOXDimport CMD_HELP, HEROKU_API_KEY, HEROKU_APP_NAME
...
async def deploy(xx, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            ...
            return repo.__del__()
        try:
            from AyiinOXD.modules.sql_helper.globals import addgvar, delgvar
...
async def update(xx, repo, ups_rem, ac_br):
    ...
    args = [sys.executable, "-m", "AyiinOXD"]
