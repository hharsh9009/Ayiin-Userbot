...
async def _(ytim):
    AyiinOXD= await eor(ytim, get_string("yitxc_53"))
    sleep(1)
    await AyiinOXD.edit(get_string("yitxc_54"))
    sleep(1)
    await AyiinOXD.edit(get_string("yitxc_55"))
    sleep(1)
    await AyiinOXD.edit(get_string("yitxc_56"))
    sleep(1)
    await AyiinOXD.edit(get_string("yitxc_57"))
    sleep(1)
    await AyiinOXD.edit(get_string("yitxc_58"))
    sleep(1)
    await AyiinOXD.edit(get_string("yitxc_59"))
    sleep(1)
    await AyiinOXD.edit(get_string("yitxc_60"))
    sleep(1)
    await AyiinOXD.edit(get_string("yitxc_61"))
    sleep(1)
    await AyiinOXD.edit(get_string("yitxc_62"))
# Create by myself @localheart
