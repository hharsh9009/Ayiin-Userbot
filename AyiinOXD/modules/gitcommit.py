...
# from AyiinOXD.events import humanbytes, progress, time_formatter
from AyiinOXDimport CMD_HELP, GIT_REPO_NAME, GITHUB_ACCESS_TOKEN, bot
from AyiinOXD.ayiin import ayiin_cmd
from Stringyins import get_string

GIT_TEMP_DIR = "./AyiinOXD/temp/"
...
async def git_commit(file_name, mone):
    ...
    file_name = "AyiinOXD/modules/" + file_name
    if create_file:
        file_name = file_name.replace("./AyiinOXD/temp/", "")
        print(file_name)
        try:
            repo.create_file(
