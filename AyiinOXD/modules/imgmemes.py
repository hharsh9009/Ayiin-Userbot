...
from AyiinOXDimport CMD_HELP, TEMP_DOWNLOAD_DIRECTORY
from AyiinOXD.ayiin import ayiin_cmd, bash, deEmojify
...
async def FakeGoogleSearch(event):
    ...
    font1 = ImageFont.truetype(
        "AyiinOXD/ayiin/styles/ProductSans-BoldItalic.ttf", 20)
    font2 = ImageFont.truetype(
        "AyiinOXD/ayiin/styles/ProductSans-Light.ttf", 23)
