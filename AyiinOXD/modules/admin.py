...
from AyiinOXDimport CMD_HELP, DEVS, WHITELIST
from AyiinOXD.events import register
from AyiinOXD.ayiin import (
    _format,
    eod,
    eor,
    get_user_from_event,
...
from AyiinOXD.ayiin.logger import logging
...
async def spider(spdr):
    try:
        from AyiinOXD.modules.sql_helper.spam_mute_sql import mute
...
async def unmoot(unmot):
    ...
    try:
        from AyiinOXD.modules.sql_helper.spam_mute_sql import unmute
    except AttributeError:
...
async def muter(moot):
    try:
        from AyiinOXD.modules.sql_helper.gmute_sql import is_gmuted
        from AyiinOXD.modules.sql_helper.spam_mute_sql import is_muted
    except AttributeError:
        return
...
async def ungmoot(un_gmute):
    ...
    try:
        from AyiinOXD.modules.sql_helper.gmute_sql import ungmute
    except AttributeError:
...
async def gspider(gspdr):
    ...
    try:
        from AyiinOXD.modules.sql_helper.gmute_sql import gmute
    except AttributeError:
