...
from AyiinOXDimport CMD_HELP, BOTLOG_CHATID
...
async def on_btpm(event):
    """ Fbtpm logic. """
    try:
        from AyiinOXD.ayiin.btpm_ayiin import get_btpm
...
async def on_btpm_save(event):
    ...
    try:
        from AyiinOXD.ayiin.btpm_ayiin import add_btpm
...
async def on_btpm_list(event):
    ...
    try:
        from AyiinOXD.ayiin.btpm_ayiin import get_fbtpm
    except AttributeError:
        await event.edit(get_string("not_sql"))
        return
...
async def on_btpm_delete(event):
    ...
    try:
        from AyiinOXD.ayiin.btpm_ayiin import remove_btpm
    except AttributeError:
        await event.edit(get_string("not_sql"))
        return
