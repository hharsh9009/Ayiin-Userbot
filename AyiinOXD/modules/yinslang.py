...
from AyiinOXDimport CMD_HELP, bot, tgbot
...
Y_BUTTONS = [
        [
           ...
           custom.Button.url("Rᴇᴘʟɪᴛ Sᴛʀɪɴɢ", "https://repl.it/@AyiinOXD/AyiinString?lite=1&outputonly=1"),
        ],
        [
           custom.Button.url("Sᴜᴘᴘᴏʀᴛ", "https://t.me/AyiinOXDSupport"),
        ],
    ]
