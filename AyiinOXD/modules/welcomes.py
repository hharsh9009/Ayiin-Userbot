...
from AyiinOXDimport BLACKLIST_CHAT, BOTLOG_CHATID, CLEAN_WELCOME
from AyiinOXDimport CMD_HANDLER as cmd
from AyiinOXDimport CMD_HELP, LOGS
from AyiinOXD.ayiin import ayiin_cmd, chataction
...
async def welcome_to_chat(event):
    try:
        from AyiinOXD.modules.sql_helper.welcome_sql import (
...
async def save_welcome(event):
    ...
    try:
        from AyiinOXD.modules.sql_helper.welcome_sql import add_welcome_setting
    except AttributeError:
...
async def show_welcome(event):
    try:
        from AyiinOXD.modules.sql_helper.welcome_sql import get_current_welcome_settings
    except AttributeError:
        return await event.edit(get_string("not_sql"))
...
async def del_welcome(event):
    try:
        from AyiinOXD.modules.sql_helper.welcome_sql import rm_welcome_setting
    except AttributeError:
        return await event.edit(get_string("not_sql"))
