...
async def fban(event):
    ...
    try:
        from AyiinOXD.modules.sql_helper.fban_sql import get_flist
...
async def addf(event):
    ...
    try:
        from AyiinOXD.modules.sql_helper.fban_sql import add_flist
    except IntegrityError:
        return await event.edit(get_string("not_sql"))
...
async def delf(event):
    ...
    try:
        from AyiinOXD.modules.sql_helper.fban_sql import del_flist
    except IntegrityError:
        return await event.edit(get_string("not_sql"))
...
async def clearf(event):
    ...
    try:
        from AyiinOXD.modules.sql_helper.fban_sql import del_flist_all
    except IntegrityError:
        return await event.edit(get_string("not_sql"))
