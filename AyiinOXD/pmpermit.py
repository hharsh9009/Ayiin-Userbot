...
from AyiinOXDimport BOTLOG_CHATID
from AyiinOXDimport CMD_HANDLER as cmd
from AyiinOXDimport CMD_HELP, COUNT_PM, DEVS, LASTMSG, LOGS, PM_AUTO_BAN, PM_LIMIT, bot
from AyiinOXD.events import ayiin_cmd
from AyiinOXD.ayiin import eod, eor
...
async def permitpm(event):
    ...
    if (
        ...
        try:
            from AyiinOXD.modules.sql_helper.globals import gvarstatus
            from AyiinOXD.modules.sql_helper.pm_permit_sql import is_approved
...
async def auto_accept(event):
    ...
    if (
        ...
        try:
            from AyiinOXD.modules.sql_helper.globals import gvarstatus
            from AyiinOXD.modules.sql_helper.pm_permit_sql import approve, is_approved
        except AttributeError:
            return
...
async def notifoff(noff_event):
    ...
    try:
        from AyiinOXD.modules.sql_helper.globals import addgvar
    except AttributeError:
...
async def notifon(non_event):
    ...
    try:
        from AyiinOXD.modules.sql_helper.globals import delgvar
    except AttributeError:
...
async def approvepm(apprvpm):
    ...
    try:
        from AyiinOXD.modules.sql_helper.globals import gvarstatus
        from AyiinOXD.modules.sql_helper.pm_permit_sql import approve
    except AttributeError:
...
async def disapprovepm(disapprvpm):
    try:
        from AyiinOXD.modules.sql_helper.pm_permit_sql import dissprove
    except BaseException:
...
async def add_pmsg(cust_msg):
    ...
    try:
        import AyiinOXD.modules.sql_helper.globals as sql
    except AttributeError:
...
async def pmdevs(event):
    ...
    try:
        from AyiinOXD.modules.sql_helper.globals import gvarstatus
        from AyiinOXD.modules.sql_helper import pm_permit_sql as yins_sql
    except AttributeError:
